...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      logical,       parameter ::  input_is_Er = .false.       !If true, Er range is (V/cm) otherwise e<a>Er/kT_e
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      open(iu_nl,file="ion_params",status="old"
     1  ,form="formatted",iostat=iocheck)
      If ( iocheck /= 0 ) Then
