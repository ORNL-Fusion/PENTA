...
!  1.2     1/18/2011   Added error check in reading D* files. JL
...
Contains
  ...
  !---------------------------------------------------------------------------
  Subroutine read_dkes_star_files(coeff_ext,Add_Spitzer_to_D33)
  ...
  Use coeff_var_pass, Only :                 &
    ! Imported arrays
    cmul_D11, cmul_D13, cmul_D31, cmul_D33,  & ! cmul arrays
    efield_D11, efield_D31,                  & ! efield arrays
    efield_D13, efield_D33,                  &
    D11_mat, D13_mat, D31_mat, D33_mat,      & ! coefficient arrays (2D)
    ! Imported scalars
    num_c_D11, num_e_D11,                    & ! Number of efield and cmul vals
    num_c_D13, num_e_D13,                    &
    num_c_D31, num_e_D31,                    &
    num_c_D33, num_e_D33
  ...
  num_c_D11 = Size(cmul_D11)
  num_e_D11 = Size(efield_D11)
  num_c_D13 = Size(cmul_D13)
  num_e_D13 = Size(efield_D13)
  num_c_D33 = Size(cmul_D33)
  num_e_D33 = Size(efield_D33)

  ! Create D31 using Onsager symmetry
  num_c_D31  = num_c_D13
  num_e_D31  = num_e_D13
  Allocate(cmul_D31(num_c_D31))
  Allocate(efield_D31(num_e_D31))
  Allocate(D31_mat(num_c_D31,num_e_D31))
  cmul_D31   = cmul_D13
  efield_D31 = efield_D13
  D31_mat    = - D13_mat
  ...
  If ( Add_Spitzer_to_D33 ) Then
    Do je = 1, num_e_D33
      Do ic = 1, num_c_D33
        ...
        ! Calculate D33* Spitzer = (2/3)/cmul
        D33_Spitzer = (2._rknd/3._rknd)/cmul_D33(ic)
