function [Coeff]=energy_conv3(jval,kval,vta,qa2,qb2,ma,na,nb,loglambda,abs_Er,vtb,logopt,cmesh,emesh,coef2d_slice,log_interp,use_quad,K_exp,nu_exp,norm_factor,coefname)
...
if use_quad
    %%%%% Using quad
    tol=1e-8;
    Coeff_tmp=quad(@intfun,Kmin,Kmax,tol,[],cmesh,emesh,vta,qa2,qb2,ma,na,nb,loglambda,abs_Er,jval,kval,vtb,coef2d_slice,logopt,log_interp,logcmesh,logemesh,coeffs_j,coeffs_k,K_exp,nu_exp,coefname);
else
    %%%% Using regtangular approx.
    Kvals=linspace(Kmin,Kmax,num_K_vals);
    dK=Kvals(2)-Kvals(1);
    Coeff_tmp=sum(intfun(Kvals,cmesh,emesh,vta,qa2,qb2,ma,na,nb,loglambda,abs_Er,jval,kval,vtb,coef2d_slice,logopt,log_interp,logcmesh,logemesh,coeffs_j,coeffs_k,K_exp,nu_exp,coefname))*dK;
end
...
function [integrand]=intfun(Kval,cmesh,emesh,vta,qa2,qb2,ma,na,nb,loglambda,abs_Er,juse,kuse,vtb,coef2d,logopt,log_interp,logcmesh,logemesh,coeffs_j,coeffs_k,K_exp,nu_exp,coefname)
