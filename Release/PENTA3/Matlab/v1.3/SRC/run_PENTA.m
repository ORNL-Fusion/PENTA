...
data_path='C:\Work\PENTA\checkout\Release\PENTA3\Matlab\v1.3\TESTS\qhs1T';
run_ident='qhs1T';
...
Er_max=100;             %Maximum Er search range value (in V/cm)
num_Er_pts=20;          %Number of Er points to use in test range
Method='SN';               %'SN': Use S-N method, 'MBT': Use M-B-T method, 
