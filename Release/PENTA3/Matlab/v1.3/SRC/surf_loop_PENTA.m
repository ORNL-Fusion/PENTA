...
if flags.calc_inductive_flow
    fprintf('CALCULATING THE INDUCTIVE FLOW ONLY FOR E_||=1\n');
end
if flags.flux_cap && strcmp(flags.Method,'SN')
    fprintf('Forcing lower bound of 0 on radial flux coefficient!\n');
end
switch flags.Method
    case 'T',
        fprintf('Using T Method\n\n');        
    case 'SN',
        fprintf('Using S-N Method\n\n');        
    case 'DKES',
        fprintf('Using DKES Method\n\n');
    case 'MBT',
        fprintf('Using M-B-T Method\n\n');
    otherwise,
