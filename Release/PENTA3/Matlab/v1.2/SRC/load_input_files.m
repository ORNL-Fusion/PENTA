...
% check order
first_chars=['&',ion_data{1}{2}(1),ion_data{1}{3}(1),ion_data{1}{4}(1)];

id1=char(ion_data{1}(first_chars=='n'));
id2=char(ion_data{1}(first_chars=='Z'));
id3=char(ion_data{1}(first_chars=='m'));

if any([isempty(id1),isempty(id2),isempty(id3)])
     error('Trouble parsing ion_params file')
end
