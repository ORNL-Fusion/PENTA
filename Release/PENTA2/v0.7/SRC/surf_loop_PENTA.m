...
for isurf = 1:numsurfs
    ...
    %define local U2
    U2_surf=ppval(csaps(U2_data(:,1),U2_data(:,2)),roa_surf);
    ...
    [gamma_e_ambi{isurf},q_e_ambi{isurf},gamma_i_ambi{isurf},q_i_ambi{isurf},J_bs_ambi{isurf},Er_roots{isurf},...
        ...
        PENTA(pprof_info,surf_VMEC_info,Er_range,ion_params,run_ident,data_path,B_Eprl(isurf),num_ion_species,U2_surf);
