function [roa_vals,Er_ambi,gamma_e,q_e,gamma_i,q_i,J_bs,J_E_e,J_E_i,J_E_cl,FFmat,X_vec]=run_PENTA(pprof_char_opt)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
plot_flux=0;            %plot fluxes vs roa for each surface
...
%Maximum order in the Sonine expansion (number of terms - 1)
Smax=2;
