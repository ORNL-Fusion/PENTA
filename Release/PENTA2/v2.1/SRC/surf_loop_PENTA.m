function [roa_vals,Er_ambi,gamma_e,q_e,gamma_i,q_i,J_bs,J_E_e,J_E_i,J_E_cl,FFmat,X_vec]=surf_loop_PENTA(data_path,run_ident,pprof_char,run_surfs,...
    Er_min,Er_max,input_is_Er,plot_pprof,postproc_plots,...
    arad,B_Eprl,num_Er_pts,plot_flux,plotit_Er_find,Smax,log_interp,use_quad,use_Ji)
...
fprintf('Maximum Sonine order: %3i \n',Smax);
for ispec=1:num_ion_species
    fprintf('Species %3i: mi/mp=%5.3f  Zi=%5.3f \n',...
...
%     disp(['Working on surface ' num2str(isurf) ' of ' num2str(numsurfs) ', r/a = ' num2str(roa_surf)]);
    ...
    %call PENTA
    [gamma_e_ambi{isurf},q_e_ambi{isurf},gamma_i_ambi{isurf},q_i_ambi{isurf},J_bs_ambi{isurf},Er_roots{isurf},...
        FFmat{isurf},X_vec{isurf},J_E_tote{isurf},J_E_toti{isurf},J_E_cl(isurf),sigma_NC2(isurf),BUprls{isurf}]=...
        PENTA(pprof_info,surf_VMEC_info,Er_range,ion_params,run_ident,data_path,B_Eprl(isurf),...
        num_ion_species,U2_surf,num_Er_pts,plot_flux,plotit_Er_find,Smax,log_interp,use_quad,use_Ji);
