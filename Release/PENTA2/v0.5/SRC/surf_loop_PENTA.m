function [Er_ambi,gamma_e,q_e,gamma_i,q_i,J_bs,J_E_e,J_E_i,J_E_cl,FFmat,X_vec]=surf_loop_PENTA(data_path,run_ident,pprof_char,run_surfs,...
    Er_min,Er_max,input_is_Er,plot_pprof,postproc_plots,num_ion_species,...
    ion_mass,Z_ion,arad,B_Eprl)
...
for isurf = 1:numsurfs
    ...
    [gamma_e_ambi{isurf},q_e_ambi{isurf},gamma_i_ambi{isurf},q_i_ambi{isurf},J_bs_ambi{isurf},Er_roots{isurf},...
        ...
        PENTA(pprof_info,surf_VMEC_info,Er_range,ion_params,run_ident,data_path,B_Eprl(isurf),num_ion_species);
