...
data_path='D:\Transport\PENTA\tests\7_2009_PENTA_Matlab_impurity_tests\qhs1T_parabola';
run_ident='qhs1T';
...
[Er_ambi,gamma_e,q_e,gamma_i,q_i,J_bs,J_E_e,J_E_i,J_E_cl,FFmat,X_vec]=...
    surf_loop_PENTA(data_path,run_ident,pprof_char,run_surfs,Er_min,Er_max,...
    input_is_Er,plot_pprof,postproc_plots,num_ion_species,ion_mass,Z_ion...
    ,arad,B_Eprl);
